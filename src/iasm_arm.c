...
static bool approx(d_float80 value, d_float80 expected)
{
...
Lsize:
    ...
    {
        s = NULL;
        if (approx(asmtok->float80value, 0.8))
            s = "8";
        else if (approx(asmtok->float80value, 0.16))
            s = "16";
        else if (approx(asmtok->float80value, 0.32))
            s = "32";
        else if (approx(asmtok->float80value, 0.64))
            s = "64";
